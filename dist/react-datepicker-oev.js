        ...
        /***/ function (module, exports, __webpack_require__) {
            ...
            var DatePicker = _react2.default.createClass({
                ...
                propTypes: {
                    ...
                    quickOptionsDay: _react2.default.PropTypes.array,
                ...
                handleSelect: function handleSelect(date) {
                    ...
                    var _this = this;
                    setTimeout(function () {
                        if (!_this.props.isDateRangePicker) {
                            _this.setOpen(false);
                        }
                    }, 1);
                },
                ...
                renderCalendar: function renderCalendar() {
                    ...
                    return _react2.default.createElement(_calendar2.default, {
                        ...
                        quickOptionsDay: this.props.quickOptionsDay,
                ...
                renderDateInput: function renderDateInput() {
                    ...
                    return _react2.default.createElement(_date_input2.default, {
                        ...
                        isDateRangePicker: this.props.isDateRangePicker,
                        date2: this.props.selected2,
                        onChangeDate2: this.setSelected2
                    });
                },
        ...
        /***/ function (module, exports, __webpack_require__) {
            ...
            var DateInput = _react2.default.createClass({
                ...
                propTypes: {
                    ...
                    isDateRangePicker: _react2.default.PropTypes.bool,
                    date2: _react2.default.PropTypes.object,
                    onChangeDate2: _react2.default.PropTypes.func
                },
                ...
                componentWillReceiveProps: function componentWillReceiveProps(newProps) {
                    if (this.props.isDateRangePicker) {
                        if (!(0, _date_utils.isSameDay)(newProps.date, this.props.date) || !(0, _date_utils.isSameDay)(newProps.date2, this.props.date2) || newProps.locale !== this.props.locale || newProps.dateFormat !== this.props.dateFormat) {
                            this.setState({
                ...
                handleChangeDate: function handleChangeDate(value) {
                    ...
                    if (this.props.isDateRangePicker) {
                        ...
                        if (this.props.onChangeDate2) {
                            var date = (0, _moment2.default)(value.substring(13, value.length), this.props.dateFormat, this.props.locale || _moment2.default.locale(), true);
                            if (date.isValid() && !(0, _date_utils.isDayDisabled)(date, this.props)) {
                                this.props.onChangeDate2(date);
                            } else if (value === '') {
                                this.props.onChangeDate2(null);
                            }
                        }
                    } else {
                        if (this.props.onChangeDate) {
                ...
                render: function render() {
                    ...
                    var isDateRangePicker = _props.isDateRangePicker;
                    var date2 = _props.date2;
                    var onChangeDate2 = _props.onChangeDate2;

                    var rest = _objectWithoutProperties(_props, ['date', 'locale', 'minDate', 'maxDate', 'excludeDates', 'includeDates', 'filterDate', 'dateFormat', 'onChangeDate', "isDateRangePicker", "date2", "onChangeDate2"]); // eslint-disable-line no-unused-vars
        ...
        /***/ function (module, exports, __webpack_require__) {
            ...
            var Calendar = _react2.default.createClass({
                ...
                componentWillReceiveProps: function componentWillReceiveProps(nextProps) {
                    if (nextProps.isDateRangePicker) {
                        if (nextProps.selected && !(0, _date_utils.isSameDay)(nextProps.selected, this.props.selected)) {
                            this.setState({
                                ...
                                date2: this.localizeMoment(nextProps.selected2)
                            });
                        }
                    } else {
                        if (nextProps.selected && !(0, _date_utils.isSameDay)(nextProps.selected, this.props.selected)) {
                ...
                getDateInView: function getDateInView(num) {
                    var _props = this.props;
                    var selected = (num == 1) ? _props.selected : _props.selected2;
                ...
                validateADate:function validateADate(date) {
                    var minDate = (0, _date_utils.getEffectiveMinDate)(this.props);
                    var maxDate = (0, _date_utils.getEffectiveMaxDate)(this.props);
                    ...
                    if (minDate && maxDate && date && date.isBetween(minDate, maxDate)) {
                        return true;
                    } else if (minDate && date && date.isAfter(minDate)) {
                        return true;
                    } else if (maxDate && date && date.isBefore(maxDate)) {
                        return true;
                    }
                    return false;
                },
                changeToDate: function changeToDate(date) {
                    if(!this.validateADate(date)) {
                        return;
                    }
                    this.setState({
                        date: date,
                ...
                changeToDate2: function changeToDate2(date) {
                    if(!this.validateADate(date)) {
                        return;
                    }
                    this.setState({
                    ...
                    return this.props.onSelect2(date);
                },
                ...
                increaseMonth2: function increaseMonth2() {
                    this.setState({
                        date: this.state.date.clone(),
                        date2: this.state.date2.clone().add(1, 'month')
                    });
                },
                ...
                decreaseMonth2: function decreaseMonth2() {
                    this.setState({
                        date: this.state.date.clone(),
                        date2: this.state.date2.clone().subtract(1, 'month')
                    });
                },
                increaseMonthBy: function increaseMonth(value) {
                    this.setState({
                        date: this.state.date.clone().add(value, 'month')
                    });
                },
                decreaseMonthBy: function decreaseMonth(value) {
                    this.setState({
                        date: this.state.date.clone().subtract(value, 'month')
                    });
                },
                handleDayClick: function handleDayClick(day) {
                    this.choseQuickOption(null);
                    this.props.onSelect(day);
                },
                handleDayClick2: function handleDayClick(day) {
                ...
                header: function header(num) {
                    var startOfWeek = num==1 ? this.state.date.clone().startOf('week') : this.state.date2.clone().startOf('week');
                ...
                renderPreviousMonthButton: function renderPreviousMonthButton(num) {
                    if (num==1) {
                        ...
                        if ((0, _date_utils.allDaysDisabledBefore)(this.state.date2, 'month', this.props)) {
                            return;
                        }
                        return _react2.default.createElement('a', {
                            className: 'react-datepicker__navigation react-datepicker__navigation--previous',
                            onClick: this.decreaseMonth2
                        });
                    }
                },
                renderNextMonthButton: function renderNextMonthButton(num) {
                    if (num==1) {
                        ...
                        if ((0, _date_utils.allDaysDisabledAfter)(this.state.date2, 'month', this.props)) {
                            return;
                        }
                        return _react2.default.createElement('a', {
                            className: 'react-datepicker__navigation react-datepicker__navigation--next',
                            onClick: this.increaseMonth2
                        });
                    }
                },
                renderCurrentMonth: function renderCurrentMonth(num) {
                    ...
                    return _react2.default.createElement(
                        ...
                        (num==1 ? this.state.date.format(this.props.dateFormat) : this.state.date2.format(this.props.dateFormat))
                    );
                },
                renderYearDropdown: function renderYearDropdown(num) {
                    if (!this.props.showYearDropdown) {
                        return;
                    }
                    if (num==1) {
                        ...
                        return _react2.default.createElement(_year_dropdown2.default, {
                            onChange: this.changeYear2,
                            year: this.state.date2.year()
                        });
                    }
                },
                ...
                renderQuickOptionsDay: function renderQuickOptionsDay() {
                    var _this = this;

                    if (!this.props.quickOptionsDay) {
                        return;
                    }
                    return _react2.default.createElement(
                        'div',
                        {className: 'react-datepicker__quick-obtions'},
                        this.props.quickOptionsDay.map(function (option, idx) {
                            return _this.renderAQuickOptionDay(option, idx)
                        })
                    );
                },
                renderAQuickOptionDay: function renderAQuickOptionDay(option, key) {
                    var _this = this;
                    ...
                    return _react2.default.createElement(
                        'button',
                        {
                            ...
                            onClick: function onClick() {
                                ...
                                var targetDate = (0, _moment2.default)();
                                switch (option.value.type) {
                                    case 'day': {
                                        console.log("The current vesion is not support quick option for day");
                                    }
                                        break;

                                    case 'month': {
                                        var monthCounter = parseInt(option.value.change);
                                        if (monthCounter > 0) {
                                            targetDate = targetDate.add(monthCounter, 'month');
                                        } else {
                                            monthCounter = (-1) * monthCounter;
                                            targetDate = targetDate.subtract(monthCounter, 'month');
                                        }
                                    }
                                        break;
                                    ...
                                    case 'year': {
                                        var monthCounter = parseInt(option.value.change);
                                        if (monthCounter > 0) {
                                            targetDate = targetDate.add(monthCounter, 'year');
                                        } else {
                                            monthCounter = (-1) * monthCounter;
                                            targetDate = targetDate.subtract(monthCounter, 'year');
                                        }
                                    }
                                        break;
                                ...
                                return _this.changeToDate(targetDate);
                            }
                        },
                        option.label
                    );
                },
                renderQuickOptionsRange: function renderQuickOptionsRange() {
                    var _this = this;

                    if (!this.props.quickOptionsRanges) {
                        return;
                    }
                    return _react2.default.createElement(
                        'div',
                        {className: 'react-datepicker__quick-obtions'},
                        this.props.quickOptionsRanges.map(function (option, idx) {
                            return _this.renderAQuickOptionRange(option, idx)
                        }),
                        this.renderApplyRangeButton()
                    );
                },
                renderAQuickOptionRange: function renderAQuickOptionRange(option, key) {
                    var _this = this;
                        ...
                        'button',
                        {
                            ...
                            onClick: function onClick() {
                                ...
                                switch (option.value.type) {
                                    ...
                                    case 'week': {
                                        var weekCounter = parseInt(option.value.change);
                                        if (weekCounter > 0) {
                                            var startDate = (0, _moment2.default)();
                                            startDate = startDate.add(7 - startDate.day() + 1, 'day');
                                            _this.changeToDate(startDate);

                                            var endDate = startDate.clone().add(6 + 7*(weekCounter - 1), 'day');
                                            _this.changeToDate2(endDate);
                                        } else {
                                            weekCounter = (-weekCounter);

                                            var endDate = (0, _moment2.default)();
                                            endDate = endDate.subtract(endDate.day(), 'day');
                                            _this.changeToDate2(endDate);

                                            var startDate = endDate.clone().subtract(6 + 7*(weekCounter - 1), 'day');
                                            _this.changeToDate(startDate);
                                        }
                                    }
                                        break;
                                    ...
                                    case 'month': {
                                        ...
                                        if (monthCounter > 0) {
                                            ...
                                            startDate = startDate.subtract(startDate.date() - 1, 'day');
                                            _this.changeToDate(startDate);

                                            var endDate = (0, _moment2.default)();
                                            endDate = endDate.add(monthCounter + 1, 'month');
                                            endDate = endDate.subtract(endDate.date(), 'day');
                                            _this.changeToDate2(endDate);
                                            ...
                                            // change month
                                            var startDate = (0, _moment2.default)();
                                            startDate = startDate.subtract(monthCounter, 'month');
                                            startDate = startDate.subtract(startDate.date() - 1, 'day');
                                            _this.changeToDate(startDate);
                                    ...
                                    case 'year': {
                                        console.log("The current vesion is not support quick option for year");
                                    }
                                        break;
                ...
                choseQuickOption: function choseQuickOption(key) {
                    this.setState({
                        date: this.state.date.clone(),
                        date2: this.state.date2.clone(),
                        quickOptionsSelected: key
                    });
                },
                renderApplyRangeButton: function renderApplyRangeButton() {
                    var _this = this;
                ...
                renderDatepicker: function renderDatepicker(num) {
                    var datepickerClass = "react-datepicker";
                    if(this.props.isDateRangePicker){
                        if(num == 1) {
                            datepickerClass += " react-datepicker__range_1";
                        } else {
                            datepickerClass += " react-datepicker__range_2";
                        }
                    }
                    if(this.props.quickOptionsDay || this.props.quickOptionsRanges) {
                        datepickerClass += " react-datepicker__with-quick-options";
                    }
                    return _react2.default.createElement(
                        'div',
                        {key: num, className: datepickerClass},
                        ((num==1 && (!this.props.isDateRangePicker)) ? _react2.default.createElement('div', {className: 'react-datepicker__triangle'}) : ''),
                        _react2.default.createElement(
                            'div',
                            {className: 'react-datepicker__header'},
                            this.renderPreviousMonthButton(num),
                            this.renderCurrentMonth(num),
                            this.renderYearDropdown(num),
                            this.renderNextMonthButton(num),
                            _react2.default.createElement(
                                'div',
                                null,
                                this.header(num)
                        ...
                        _react2.default.createElement(_month2.default, {
                            day: num == 1 ? this.state.date : this.state.date2,
                            onDayClick: num==1 ? this.handleDayClick : this.handleDayClick2,
                            minDate: this.props.minDate,
                            maxDate: this.props.maxDate,
                            excludeDates: this.props.excludeDates,
                            includeDates: this.props.includeDates,
                            fixedHeight: this.props.fixedHeight,
                            filterDate: this.props.filterDate,
                            selected: num==1 ? this.props.selected : this.props.selected2,
                            startDate: this.props.startDate,
                            endDate: this.props.endDate
                        }),
                ...
                render: function render() {
                    return _react2.default.createElement(
                        'div',
                        {className: ''},
                        (this.props.isDateRangePicker ? [this.renderDatepicker(1), this.renderDatepicker(2)] : this.renderDatepicker(1)),
                        this.renderQuickOptionsDay(),
                        this.renderQuickOptionsRange()
                    );
                }
            });
